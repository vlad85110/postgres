...
rest_port(int child_type)
{
    switch(child_type)
    {
        ...
        case B_WAL_SENDER:      return PostPortNumber + 1001;
        case B_WAL_WRITER:      return PostPortNumber + 1002;
        case B_BG_WRITER:       return PostPortNumber + 1003;
        case B_CHECKPOINTER:    return PostPortNumber + 1004;
        case B_AUTOVAC_LAUNCHER:return PostPortNumber + 1005;
        default:                return -1;
    }
}
